...
TOP_CLUBS = ['Manchester United', 'Manchester City', 'Chelsea', 'Liverpool', 
             ...
             'Napoli', 'Inter', 'FC Barcelona', 'Real Madrid', 'Atlético Madrid',
...
PROMO_DATES = [[datetime(2020, 1, 6), datetime(2020, 1, 13)],        # TOTY
               [datetime(2019, 12, 14), datetime(2019, 12, 24)],     # futmas
               [datetime(2019, 12, 6), datetime(2019, 12, 13)],      # TOTGS
               [datetime(2019, 11, 29), datetime(2019, 12, 1)],      # black friday
...
# Column order
COLUMNS = ['player_name', 'revision', 'overall', 'club', 'league', 'nationality',
          'position', 'age', 'height', 'weight', 'intl_rep', 'added_date', 'pace',
          ...
          'def_workrate', 'weak_foot', 'skill_moves', 'resource_id', 'num_games',
          'avg_goals', 'avg_assists', 'date', 'price']


COLUMN_DTYPES = [dtype('O'), dtype('O'), dtype('int64'), dtype('O'), dtype('O'),
                dtype('O'), dtype('O'), dtype('int64'), dtype('int64'), 
                dtype('int64'), dtype('int64'), dtype('<M8[ns]'), 
...
ATTR_COLS = ['overall', 'club', 'league', 'nationality', 'position', 'height', 
             ...
             'dribbling', 'drib_agility', 'drib_balance', 'drib_reactions', 'drib_ball_control', 
             'drib_dribbling', 'drib_composure', 'shooting', 'shoot_positioning', 'shoot_finishing', 
             'shoot_shot_power', 'shoot_long_shots', 'shoot_volleys', 'shoot_penalties', 'passing', 
             'pass_vision', 'pass_crossing', 'pass_free_kick', 'pass_short', 'pass_long', 'pass_curve', 
             'defending', 'def_interceptions', 'def_heading', 'def_marking', 'def_stand_tackle', 'def_slid_tackle', 
