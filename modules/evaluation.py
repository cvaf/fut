...
def run():
  ...
  logging.debug('Evaluated predictions.')

  evaluation_file = f'data/evaluation_{model_name}.pkl'
  df.to_pickle(evaluation_file, protocol=4)
  logging.info(f'Evaluation dataframe saved at: {evaluation_file}')
